...
fetch(
    ...
    "https://raw.githubusercontent.com/jasmendes/jasmendes.github.io/master/questions/questions-philosophy.json"
...
getNewQuestions = async () =>{
    ...
    if(availableQuestions.length ===0 || questionCounter >= MAX_QUESTIONS){
        ...
        sessionStorage.setItem('lastScoreSubject', 'Filosofia 11 Ano');
        ...
        try {
            if (window.saveScore) {
                await window.saveScore(score, 'Filosofia 11 Ano', 'medium', MAX_QUESTIONS);
